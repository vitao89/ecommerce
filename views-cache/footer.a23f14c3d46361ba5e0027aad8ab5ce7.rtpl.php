<?php if(!class_exists('Rain\Tpl')){exit;}?>	<div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/loja/res/site/js/owl.carousel.min.js"></script>
    <script src="/loja/res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/loja/res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/loja/res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/loja/res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/loja/res/site/js/script.slider.js"></script>
  </body>
</html>